## precisa consertar animacao do pulo (up, down, middle)
## pulo com altura variavel (fraco e forte)
...
export var normal_jump = 800		# base jump height (affects the higher one)
